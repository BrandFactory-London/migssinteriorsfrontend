...
export const SERVICES: Record<ServiceSlug, Service> = {
  ...
  kitchen: {
    ...
    spec: {
      ...
      lead: "A kitchen is a building job with furniture in it. We quote the whole thing — structure, services, floors, plaster and decoration — so there is no second bill from someone else halfway through.",
