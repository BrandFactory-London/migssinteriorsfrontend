...
/** Overlays the hero, so it inherits the light-on-dark treatment. */
export function SiteHeader() {
  return (
    <header className="absolute inset-x-0 top-0 z-30 text-migss-neutral-100">
      <div className="mx-auto flex max-w-[1280px] items-center gap-4 px-[clamp(16px,4.5vw,48px)] py-[18px]">
        <a href="#top" className="mr-auto text-inherit no-underline">
          <Wordmark />
