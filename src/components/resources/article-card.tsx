...
import { postMeta, type BlogPost } from "@/lib/blog-post";
...
export function ArticleCard({
  ...
  post: BlogPost;
  /** Tag labels by ID, for the badge. Omitted where no badge is wanted. */
  tagLabels?: Record<string, string>;
}) {
  const badge = post.tagIds
    .map((id) => tagLabels?.[id])
