    ...
    <>
      ...
      <main id="top">
        ...
        <section className="relative z-3 mx-auto max-w-[1280px] px-[clamp(16px,4.5vw,48px)]">
          <dl className="mt-[clamp(-46px,-3.5vw,-30px)] grid grid-cols-[repeat(auto-fit,minmax(min(50%,170px),1fr))] gap-px border border-[var(--migss-divider)] bg-[var(--migss-divider)] shadow-migss-md">
            {facts.map((fact) => (
              <div
                key={fact.label}
